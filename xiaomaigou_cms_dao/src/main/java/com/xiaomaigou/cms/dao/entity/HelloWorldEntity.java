...
public class HelloWorldEntity implements Serializable {
    ...
    public HelloWorldEntity(Long helloWorldId, String title, String content, String url, String pic, BigDecimal price, Integer sortOrder, Long createPersonId, Long updatePersonId, Date createTime, Date updateTime, Integer status) {
